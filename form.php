...
//
$mail_sys = "yukatariwan@gmail.com";	// 管理者のメールアドレス
$from_name = "Takuya WebDesign Company";	// メール送信者の表示
$from_mail = "yukatariwan@gmail.com";	// メール送信者のメールアドレス（返信先）
